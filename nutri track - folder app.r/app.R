...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    tags$div(
      class = "sidebar-logo", 
      tags$img(src = "https://cdn-icons-png.flaticon.com/512/3373/3373653.png", width = "80px"),
    ...
    sidebarMenu(
      ...
      conditionalPanel(
        ...
        numericInput("age", "Usia (bulan)", value = 12, min = 0, max = 60),
        awesomeRadio("sex", "Jenis Kelamin", 
                     choices = c("Laki-laki" = "Male", "Perempuan" = "Female"),
                     selected = "Male", status = "primary"),
        numericInput("height", "Tinggi Badan (cm)", value = 60, min = 45, max = 120),
